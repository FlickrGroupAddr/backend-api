/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 33ec74e7bbd7ef95fdd6a9d23b4efb68)
...
interface __BaseEnv_Env {
	...
	API_BASE_URL: string;
	UI_ORIGIN: string;
	OAUTH_LOGIN: DurableObjectNamespace<import("./src/index").OAuthLoginAttempt>;
	DEVICE_LINK: DurableObjectNamespace<import("./src/index").DeviceLinkAttempt>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OAuthLoginAttempt" | "DeviceLinkAttempt";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FLICKR_CONSUMER_KEY" | "FLICKR_CONSUMER_SECRET" | "TOKEN_KEY" | "SESSION_KEY" | "ADMIN_NSIDS" | "API_BASE_URL" | "UI_ORIGIN">> {}
}
